      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-10 lg:px-20">
        ...
        >
          ...
          <nav className="hidden xl:flex items-center gap-6">
            {NAV_LINKS.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="text-xs font-medium text-slate-300 hover:text-white transition-all duration-200 relative py-1 px-2 rounded-lg hover:bg-white/[0.04] hover:scale-105 group"
              >
                {link.label}
                <span className="absolute bottom-0 left-2 right-2 h-0.5 w-0 bg-gradient-to-r from-indigo-500 to-cyan-400 transition-all duration-300 group-hover:w-[calc(100%-16px)] rounded-full mx-auto" />
              </a>
            ))}
          </nav>
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a
              href="#kalkulator"
              className="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-300 hover:text-white px-3 py-2 rounded-lg hover:bg-white/[0.06] hover:scale-105 active:scale-95 transition-all duration-200 border border-transparent hover:border-white/10"
            >
            ...
            <a
              ...
              className="btn-primary text-xs py-2.5 px-4 font-semibold hover:scale-105 active:scale-95 transition-all duration-200"
            >
